...
export const UI_CONFIG = {
    ...
    // SCROLL_THRESHOLD_TOP: Khoảng đệm tính từ mép trên của vùng nội dung (#content)
    SCROLL_THRESHOLD_TOP: 80, 
    // SCROLL_THRESHOLD_BOTTOM: Khoảng đệm tính từ mép dưới của vùng nội dung (#content)
